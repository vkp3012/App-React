            ...
            <div className='col-8'>
              <div className='d-flex justify-content-center align-items-center gap-30'>
                <div className='gap-30 pt-5 '>
                  ...
                  <div className="progress gap-30 m-2" style={{width: "1000px"}}>
                    <div className="progress-bar progress-bar-striped progress-bar-animated text-center" role="progressbar" style={{width: "85%"}} aria-valuenow="10" aria-valuemin="0" aria-valuemax="100">85%</div>
                    <strong>CSS</strong>
                  </div>
                  <div className="progress gap-30 m-2" style={{width: "1000px"}}>
